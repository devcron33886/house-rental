...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'Taotal subscribers',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings6 = [
            'chart_title'           => 'House Chart By Users',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\House',
            'group_by_field'        => 'created_at',
        ...
        return view('home', compact('settings1', 'settings2', 'settings3', 'settings4', 'chart5', 'chart6', 'chart7', 'settings8', 'settings9', 'chart10','chart11'));
    }
}
